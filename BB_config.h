...
#define PIN_BATT_M1		13	// Arduino Nano have LED connected to this pin. Useful for debugging
#define PIN_BATT_M2		12	//
...
#define VrefBEC			3.276 // value in V
#define VrefBATT		3.276 // value in V
...
#define BATT2_V_OFFSET	0.070	// Offset for adjusting final voltage calculation
#define BEC1_V_OFFSET	0.000	// Offset for adjusting final voltage calculation
...
#define BATT_LOW_THRSLD_NORM 	6.6 // 9 volts is the threshold for switching from the main battery to backup after a delay
#define BATT_LOW_THRSLD_SHORT	6.3 // 8 volts is the threshold for switching from the main battery to backup imideatly
